<!-- 
    - WatchEffect() allow us shotern the watch & validation steps and react to changes without listing each one in the source  
    - Replace deep watcher which monitors all dependencies to only dependencies listed
...
<template>
  ...
  // Activate watch for email and password
  ...
  watchEffect(() => { // No need to list the dependencies
