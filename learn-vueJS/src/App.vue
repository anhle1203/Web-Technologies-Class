<template>
    ...
    <h2>
      Number of active users (method call): {{ computeNumberOfActiveUsers() }} <!--Computed properties is also a ref object and auto unwrapped in the method -->
    </h2>
    <h2>
  ...
  // Computed properties code example: scalable, reusable, and efficient
